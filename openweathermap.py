...
def main(db_url: str, start: str, end: str):
    ...
    params = {
        ...
        "start_date": dt_start,
        "end_date": dt_end,
        "hourly": ["temperature_2m", "relative_humidity_2m", "rain", "snowfall", "wind_speed_10m", "wind_direction_10m",
    ...
    hourly_data = {"date": pd.date_range(
        ...
        # check if it has to be changed to gmt somehow, since the data is the same as for gmt in the teacher's link
    ...
    Keys = {"date": DateTime(), "unixtime": Integer(), "temperature_2m_°C": Float(), "relativehumidity_2m": Float(),
            "rain_mm": Float(),
            "snowfall_cm": Float(), "windspeed_10m_km": Float(), "winddirection_10m_°": Float(),
            "soil_temperature_0_to_7cm_°C": Float()}
...
if __name__ == '__main__':
    ...
    if sys.argv[1] in ['-h', '--help']:
        ...
        print(" example:")
        print("openweathermap.py -d sqlite:///myhome.db 2022-01-01 2024-04-01")
